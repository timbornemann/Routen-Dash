...
export default function App() {
  ...
  return (
    <div className="h-[100dvh] bg-brand-bg font-sans text-brand-text flex flex-col overflow-hidden">
      <main className="flex-1 overflow-hidden flex flex-col w-full h-full max-w-md mx-auto shadow-2xl bg-brand-surface border-x border-brand-border">
        
        {/* Top Header */}
        <header
          className="h-16 px-6 flex items-center border-b border-brand-border shrink-0"
          style={{ paddingTop: 'env(titlebar-area-height, 0px)', height: 'calc(4rem + env(titlebar-area-height, 0px))' }}
        >
